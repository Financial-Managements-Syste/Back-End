...
@EnableJpaRepositories(
        basePackages = "com.example.category_service.repository.sqlite",
...
public class SQLiteDataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean sqliteEntityManagerFactory(
        ...
        emf.setPackagesToScan("com.example.category_service.entity.sqlite");
        emf.setJpaVendorAdapter(new HibernateJpaVendorAdapter());

        Map<String, Object> props = new HashMap<>();
        props.put("hibernate.hbm2ddl.auto", "update");
        props.put("hibernate.show_sql", "true");
        props.put("hibernate.dialect", "com.example.category_service.dialect.SQLiteDialect");
